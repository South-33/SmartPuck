...
export const MessageList = memo(function MessageList({
  ...
  // Reasoning and tool rows already carry their own active treatment. Showing
  // the generic typing bubble beneath them duplicates the avatar and makes a
  // finished-looking tool run appear stuck.
  const hasVisibleAgentActivity = visibleMessages.some((message) => {
  ...
  return (
    <>
      ...
      {isLoading && !lastMessageIsAgent && !hasVisibleAgentActivity && (
