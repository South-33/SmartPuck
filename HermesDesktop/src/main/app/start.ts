...
import {
  resumeSmartPuckTranscriptions,
  stopSmartPuckTranscriptionWorker,
} from "../smartpuck-transcription";
        ...
        responseHeaders: {
          ...
          "Content-Security-Policy": [
            "default-src 'self'; " +
              ...
              "connect-src 'self' blob: http: http://127.0.0.1:* http://localhost:* ws://127.0.0.1:* ws://localhost:* https: wss:; " +
              "font-src 'self' data:; " +
