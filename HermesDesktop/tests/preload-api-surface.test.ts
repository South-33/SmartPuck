...
describe("New APIs from v0.8/v0.9 features", () => {
  it("has the SmartPuck local-library namespace", () => {
    expect(preloadSrc).toContain("smartPuck: {");
    expect(preloadTypes).toContain("smartPuck: {");
    expect(preloadSrc).toContain("getDeviceSnapshot:");
    expect(preloadTypes).toContain("getDeviceSnapshot:");
  });
