...
- [[smartpuck]] — the local meeting-library front door that imports recordings into real folders and reuses Hermes folder-scoped chat instead of a web-hosted agent stack.
