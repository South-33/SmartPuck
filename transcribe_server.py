...
class LocalTranscriptionRequest(BaseModel):
    ...
    denoise_mode: str = "off"  # "off", "auto", "strong"
...
def run_transcription(
    ...
    if denoise_mode == "auto":
        ...
        raw_result = run_transcription_inner(
            ...
            denoise_mode="off", normalize=normalize, force_cpu=force_cpu
        )
...
async def transcribe_local(request: LocalTranscriptionRequest):
    ...
    try:
        ...
        denoised_dest = os.path.join(recording_dir, "recording.denoised.wav")
